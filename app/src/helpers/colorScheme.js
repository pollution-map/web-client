...
const scaleWithDomain = (interpolator, domain) => scaleSequential(interpolator).domain(domain);

const german = (domain) => scaleWithDomain(interpolateDiscrete([
  '#82a6ad',
  '#a0babf',
  '#b8d6d1',
  '#cee4cc',
